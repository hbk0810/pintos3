...
void filluserstack(int argc, char** argv, void** esp);
...
process_execute (const char *file_name) 
{
  ...
  /**/
  char* p;
  char* true_name = strtok_r((char*)file_name, " ", &p);
  if(filesys_open(true_name) == NULL)
	  return -1;
  /**/
...
start_process (void *file_name_)
{
  ...
  if(success) {
	filluserstack(argc, argv, &if_.esp);
  }
  /**/
